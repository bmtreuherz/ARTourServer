  ...
  User.findOne({
    ...
    if (!user) {
      ...
      if (user.password != req.body.password) {
        ...
        expirationDate.setHours(expirationDate.getHours() + config.tokenExpirationTime);
...
var validateToken = function(req, callback){
...
apiRoutes.use(function(req, res, next) {
  validateToken(req, function(result){
    if(result.success){
      next();
    }else{
